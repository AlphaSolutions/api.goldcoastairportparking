...
class Rates_model extends CI_Model 
{
    ...
    public function getJoinWhere( $where = NULL, $sort = null, $limit = NULL)
    {
        ...
        $this->db->join('rate_details rd', 'r.rate_id = rd.rate_id', 'inner');
        $this->db->join('travel_agents ta', 'ta.company_id = r.company_id', 'left');
...
/* Location: ./system/application/models/Rates_model.php */